 ...
 */
function maya_preprocess_page(&$variables) {
 ...
 * Return a full tree of the expanded menu. Thank you multiflex-3 for this code!
 */
function maya_secondary_footer() {
  $output = '<div id="footer_links">';
  $output .= menu_tree(variable_get('menu_secondary_links_source', 'secondary-links'));
  $output .= '</div>';
  return $output;
}
 ...
 */
function maya_breadcrumb($breadcrumb) {
 ...
 */
function maya_preprocess_comment(&$variables) {
