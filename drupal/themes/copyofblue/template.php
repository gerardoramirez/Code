 ...
 */
function copyofblue_preprocess_page(&$variables) {
 ...
 */
function copyofblue_preprocess_comment(&$variables) {
 ...
 */
function copyofblue_preprocess_search_theme_form(&$vars, $hook) {
